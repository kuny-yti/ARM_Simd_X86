...
#define mmCmpPD(X, Y, O, I)\
    ...
    if (O.u32[0] != g_test_mm256_cmp_ps_data[i].expect[I].e[0] || \
        O.u32[1] != g_test_mm256_cmp_ps_data[i].expect[I].e[1] || \
        O.u32[2] != g_test_mm256_cmp_ps_data[i].expect[I].e[2] || \
        O.u32[3] != g_test_mm256_cmp_ps_data[i].expect[I].e[3] || \
        O.u32[4] != g_test_mm256_cmp_ps_data[i].expect[I].e[4] ||  \
        O.u32[5] != g_test_mm256_cmp_ps_data[i].expect[I].e[5] || \
        O.u32[6] != g_test_mm256_cmp_ps_data[i].expect[I].e[6] || \
        O.u32[7] != g_test_mm256_cmp_ps_data[i].expect[I].e[7] ) \
    return FALSE
